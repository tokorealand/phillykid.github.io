...
function generateMedia() {
  ...
  var lessThan = function lessThan(breakpoint) {
    return function () {
      return styledComponents.css(_templateObject, getSizeFromBreakpoint(breakpoint, breakpoints), styledComponents.css.apply(undefined, arguments));
    };
  };

  var greaterThan = function greaterThan(breakpoint) {
    return function () {
      return styledComponents.css(_templateObject2, getSizeFromBreakpoint(breakpoint, breakpoints), styledComponents.css.apply(undefined, arguments));
    };
  };

  var between = function between(firstBreakpoint, secondBreakpoint) {
    return function () {
      return styledComponents.css(_templateObject3, getSizeFromBreakpoint(firstBreakpoint, breakpoints), getSizeFromBreakpoint(secondBreakpoint, breakpoints), styledComponents.css.apply(undefined, arguments));
    };
  };
...
//# sourceMappingURL=styled-media-query.common.js.map
